...
--2)Siparişlerde tutarı 600 den büyük sipariş varsa müşterilerin yaş ortalamasını bul .(bağımsız)
...
--7)İstanbulda yaşayan müşteri varsa sipariş tutarından 50 br indirim yapınız ve tüm siparişleri listeleyiniz.
